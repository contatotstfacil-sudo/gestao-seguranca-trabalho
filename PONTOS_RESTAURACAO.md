...
- **restore-point-2025-11-17_12-01-25**: Implementação banco CBO (Classificação Brasileira de Ocupações), exclusão em massa Setores, ordenação alfabética em todas as listas do sistema (17/11/2025 12:01:25)
