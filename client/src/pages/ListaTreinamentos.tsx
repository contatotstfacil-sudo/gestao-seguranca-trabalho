...
export default function ListaTreinamentos({ showLayout = true }: { showLayout?: boolean }) {
  ...
  const content = (
    <div className="space-y-6">
      <div className="flex justify-between items-center">
        <div>
          <h2 className="text-2xl font-bold">Relatório de Treinamentos Feitos</h2>
          <p className="text-muted-foreground mt-1">Visualize e gerencie todos os treinamentos realizados</p>
        </div>
      ...
      <Card>
        <CardHeader>
            <CardTitle>Relatório de Treinamentos Feitos</CardTitle>
        </CardHeader>
        <CardContent>
          {isLoading ? (
